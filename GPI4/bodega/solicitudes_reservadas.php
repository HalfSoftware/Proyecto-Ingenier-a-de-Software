...
<section class="engine"><a href="https://mobiri.se/k">how to develop your own website</a></section><section class="mbr-section mbr-section__container article mbr-after-navbar" id="header3-v" data-rv-view="87" style="background-color: rgb(239, 239, 239); padding-top: 20px; padding-bottom: 0px;">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <h3 class="mbr-section-title display-2"><br><br>Solicitudes Reservads</h3>
                <small class="mbr-section-subtitle"><p>Todas las solicitudes que se han revisado las existencias de sus materiales con el inventario&nbsp;&nbsp;&nbsp;&nbsp;</p></small>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="mbr-section mbr-section__container mbr-section__container--middle">
        <div class="container">
            <div class="row">
					...
					<table ><form class="mbr-form" method='post' action='solicitudes_reservadas.php' >
