...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 mx-auto"> 
				...
				<h2>Lista de Solicitudes para la obra del usuario</h2>
				<br>
				<table class="table table-hover">
				<thead class="thead-dark"><tr><th>N°Soliciud</th><th>Obra</th><th>Fecha emisión</th><th>Solicitado por</th><th>estado</th></tr>
				</thead>
